...
class HomeComponent extends Component {
  ...
  checkBoxAction =(idNum)=>{
    ...
    const updatedTask = updatedTasks.find((task) => task._id === idNum);
          ...
          <ul className="todo-items-container">
            {
              initialTasks.map((eachObject)=>(
                <MyTasks eachObject={eachObject} checkBoxProp={this.checkBoxAction} deleteButtonClickedProp={this.deleteButtonTriggered} key={eachObject._id} />
              ))
            }
          </ul>
        </div>
